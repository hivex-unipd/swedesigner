...
/**
 * A {@code ParsedInterface} object represents a
 * purely asbtract type of a {@code ParsedProgram}.
 */
public class ParsedInterface extends ParsedType {
	...
	public void addMethod(ParsedMethod parsedMethod) throws ParsedException {
		...
		if (metBody != null)
			size = metBody.size();
		if ((metVisibility == null || metVisibility.equals("public") || metVisibility.equals("package")) && size == 0)
	...
	public void addSupertype(String name, String type)throws ParsedException {
		if (name != null && type != null) {
			...
			throw new ParsedException("ParsedInterface error: missing information of supertype (name or type)");
	}
