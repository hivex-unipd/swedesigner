...
public class ProvaMain {//SIMULO IL PROGRAMMA PRINCIPALE
	...
	public static void main(String[] args) throws IOException, JSONException, Exception{
		...
		ZipEntry ze= new ZipEntry("px"); /*This class is used to represent a ZIP file entry*//*da il nome al file dentro
		lo zip*/
		...
		int len;
		while ((len = in.read(buffer)) > 0) {/*	read(byte[] b) Reads up to b.length bytes of data from this input 
